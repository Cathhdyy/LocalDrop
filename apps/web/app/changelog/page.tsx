...
export default function ChangelogPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-blue-500/30 flex flex-col relative overflow-x-hidden">
      ...
      {/* HEADER / NAVIGATION                                           */}
      {/* ============================================================ */}
      <header className="sticky top-0 z-40 w-full border-b border-border/70 bg-background/85 dark:bg-[#09090c]/85 backdrop-blur-2xl transition-colors">
      ...
      <main className="relative z-10 flex-1 max-w-3xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-24">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 pb-10 sm:pb-14 border-b border-border/60">
        ...
        <div className="mt-16 sm:mt-24 pt-8 border-t border-border/60 text-center space-y-4">
